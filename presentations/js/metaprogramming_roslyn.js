(function() {
    ...
    jsPlumb.ready(function() {
        ...
        allTargetEndpoints = [];
            addEndpointsFunc = function(toId, sourceAnchors, targetAnchors) {
        ...
        addEndpointsFunc("ScriptJson", ["BottomCenter"], [ ]);            
        addEndpointsFunc("DtoJson", ["BottomCenter"], [ ]);            
        addEndpointsFunc("InputJson", ["BottomCenter"], [ ]);  

        addEndpointsFunc("RoslynCreatesCubmission", ["BottomCenter"], ["TopCenter"]);
        addEndpointsFunc("RuntimeT4", ["BottomCenter"], ["TopCenter"]);
        addEndpointsFunc("RoslynDynamicAssembly", ["RightMiddle"], ["TopCenter"]);


        addEndpointsFunc("AppDomain", ["RightMiddle"], ["TopCenter", "LeftMiddle"]);
        addEndpointsFunc("Processing", [], ["TopCenter", "LeftMiddle"]);
